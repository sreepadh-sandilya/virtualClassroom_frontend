        ...
        <>
            ...
            {isLoading || data === null || !data.length > 0 ? <LoadingScreen /> : (
                <main className="flex flex-1 flex-col mt-24 w-[80%] ml-auto mr-auto items-center justify-center">
                    ...
                    <Link href={`/a/course/${courseId}/add-class`} className="mt-4 bg-gray-200 text-black px-4 py-2 rounded-2xl border w-[32%] text-center border-[#cdcdcd] hover:cursor-pointer">Add New Class</Link>
